...
export async function installDevelopmentPreview(preview: "ready" | "empty" | "process-running" | "job" | "mapping" | "conflict" | "failure" | "history") {
  ...
  mockIPC((command, args) => {
    ...
    if (command === "plan_local_trash_purge") return { schemaVersion: 1, createdAt: "2026-07-31T12:00:00Z", operationIds: ["019fa1a0-7777-7777-8777-777777777777"], trashEntryCount: 1, candidateObjects: [], objectReclaimableBytes: 10000000, trashMetadataBytes: 4096, retainedSharedBytes: 2000000, planFingerprint: `sha256:${"d".repeat(64)}` };
    if (command === "purge_local_trash") return { operationId: "019fa1a0-aaaa-7aaa-8aaa-aaaaaaaaaaaa", deletedTrashEntries: 1, deletedObjectCount: 3, freedBytes: 10004096, retainedSharedBytes: 2000000, journalPath: "C:/Users/demo/.codex-session-sync/journal/local-trash-purge.json" };
    if (command === "purge_remote_history_trash") return { purgedOperationCount: 1, purgedRevisionCount: 2, deletedObjectCount: 3, reclaimedBytes: 10000000 };
    ...
    if (command === "list_local_backups") return [{ id: "repository:checkout-demo", category: "checkout", location: "repository", path: "C:/Users/demo/.codex-session-sync/backups/checkout-demo", createdAt: "2026-07-31T09:10:00Z", byteCount: 52428800, fileCount: 4, deletable: true }, { id: "repository:workspace-cleanup-demo", category: "workspace_cleanup", location: "repository", path: "C:/Users/demo/.codex-session-sync/backups/workspace-cleanup-demo", createdAt: "2026-07-30T08:00:00Z", byteCount: 4096, fileCount: 1, deletable: true }];
    if (command === "delete_local_backups") return { deletedCount: 1, freedBytes: 52428800 };
